...
const submitHandler= async(e)=>{
  ...
  return (
    <div>
      ...
      <span className='text-3xl items-center text-center '>sign in</span>
      ...
      <button disabled={loading} className='rounded-lg p-4 bg-slate-500 text-white items-center hover:bg-slate-700' onClick={submitHandler}>{!loading?'Sign in':'Loading...'}</button>

      </form>
        <div className='flex justify-center  max-w-lg mx-auto gap-5'>
          <p className=''>Dont have an acount ?</p>
          <Link className='text-slate-500' to="/signup">sign up</Link>
        </div>
